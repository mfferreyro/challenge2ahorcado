function iniciarJuego(){
    document.getElementById("iniciar-juego").style.display = "none";
         ...
         /* Variables */
            ...
            palabras_array.push("ALURA");
            palabras_array.push("AVESTRUZ");
            palabras_array.push("CSS");
            palabras_array.push("HTML");
            palabras_array.push("ARTURO");
            palabras_array.push("MANUELA");
            palabras_array.push("AGUILA");
            palabras_array.push("ARGENTINA");
            palabras_array.push("VERANO");
            palabras_array.push("JAVASCRIPT");
            palabras_array.push("AGUA");
            palabras_array.push("ZAPALLO");
            palabras_array.push("AHORCADO");
            palabras_array.push("JUEGO");
            palabras_array.push("LUNA");
            palabras_array.push("ESTRELLAS");
            ...
            function pistaFunction(palabra){
                ...
                switch(palabra){  // Se crea un switch para poder controlar las pistas segun la palabra 
                    ...
                    case 'GATO':
                        ...
                        break;
                    case 'ARGENTINA':
                        pista = "País es conocido por el tango";
                        break;
